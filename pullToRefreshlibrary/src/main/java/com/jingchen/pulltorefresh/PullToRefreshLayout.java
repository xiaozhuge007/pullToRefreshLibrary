...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public boolean mPullDownEnable = true;
    public boolean mPullUpEnable = true;
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                if (null == customRefreshView) {
                    ...
                    refreshStateTextView.setText(getResources().getString(R.string.refresh_succeed));
            ...
            default:
                ...
                if (null == customRefreshView) {
                    refreshStateImageView.setVisibility(View.VISIBLE);
                    refreshStateTextView.setText(getResources().getString(R.string.refresh_fail));
                    refreshStateImageView
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                if (null == customLoadmoreView) {
                    ...
                    loadStateTextView.setText(getResources().getString(R.string.loading));
                    loadStateImageView
            ...
            default:
                ...
                if (null == customLoadmoreView) {
                    loadStateImageView.setVisibility(View.VISIBLE);
                    loadStateTextView.setText(getResources().getString(R.string.load_fail));
                    loadStateImageView
        ...
        switch (state) {
            case INIT:
                ...
                if (null == customRefreshView) {
                    ...
                    refreshStateTextView.setText(getResources().getString(R.string.pull_to_refresh));
                ...
                if (null == customLoadmoreView) {
                    ...
                    loadStateTextView.setText(getResources().getString(R.string.pullup_to_load));
            ...
            case RELEASE_TO_REFRESH:
                ...
                // 释放刷新状态
                if (null == customRefreshView) {
                    refreshStateTextView.setText(getResources().getString(R.string.release_to_refresh));
            ...
            case REFRESHING:
                ...
                if (null == customRefreshView) {
                    ...
                    refreshStateTextView.setText(getResources().getString(R.string.refreshing));
                }
                break;
            case RELEASE_TO_LOAD:
                ...
                // 释放加载状态
                if (null == customLoadmoreView) {
                    loadStateTextView.setText(getResources().getString(R.string.release_to_load));
    ...
    private void releasePull() {
        if (setPullDownEnable(mPullDownEnable)) {
            mCanPullDown = true;
        }
        if (setPullUpEnable(mPullUpEnable)) {
            mCanPullUp = true;
        }
    }
     ...
     */
    public boolean setPullDownEnable(boolean pullDownEnable) {
     ...
     * 设置是否可上拉刷新
     */
    public boolean setPullUpEnable(boolean pullUpEnable) {
